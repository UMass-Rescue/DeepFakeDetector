...
def copy_images(source_dirs, dest_dir, max_images=10000):
    ...
    for source_dir in source_dirs:
        ...
        for file_name in os.listdir(source_dir):
            ...
            if source_dir == "datasets/dffd/img_align_celeba" and int(file_name.split(".")[0]) < 190000:
                continue
            ...
            if os.path.isfile(file_path) and Path(file_path).suffix.lower() in img_extensions:
                try:
...
source_directories = [
    "datasets/dffd/pggan_v2/test",
    "datasets/dffd/img_align_celeba"
]
